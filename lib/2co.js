...
var tco = function() {
    ...
    this._NotificationPath = '/payments/2co/notifications';
    ...
    this.expressHelper = function(app){
        ...
        ['get', 'post'].forEach(function(method){
            app[method](self.CallbackRoute(), self.scriptCallback());
            app[method](self.NotificationPath(), self.notificationCallback());
        });
    };
};
