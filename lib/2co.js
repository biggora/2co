...
var tco = function() {
    ...
    this._shoppingCartFiller = function(req,res) {
        var data = req.query || {};
        res.send(data);
    };
    this.shoppingCartFiller = function(callback) {
        var self = this;

        if (typeof callback != 'function') {
            return self._shoppingCartFiller;
        }
        self._shoppingCartFiller = function(req,res){
            var data = req.query || {},
            sess = req.session || {},
            cart = sess.cart || {};
    ...
    this.expressHelper = function(app){
        ...
        ['get', 'post'].forEach(function(method){
            ...
            app[method](self.shoppingCartRoute(), self.shoppingCartFiller());
        });
